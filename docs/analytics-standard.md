...
Имена аналитических объектов определяются [стандартом именования](naming-convention.md).
...
Не следует строить универсальную витрину с сотнями полей «на все случаи».
