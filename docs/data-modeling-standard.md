...
Имена SQL-объектов, колонок, ключей, ограничений и технических идентификаторов определяются [стандартом именования](naming-convention.md).

Предметное имя выбирается после определения смысла, зернистости и идентичности объекта.
