...
**Файловая система** хранит документы, изображения, архивы, исходные выгрузки и другие объекты, для которых файл является естественной формой хранения. Физический оригинал файловой поставки может сохраняться как артефакт соответствующей загрузки. PostgreSQL хранит необходимые метаданные и связи файлов с объектами ядра.
...
- аналитический слой;
- сохранение и трассировку файловых артефактов загрузок;
- SQL-миграции и базовые правила эксплуатации.

Проект задает архитектуру ядра данных и связанные с ней технические контракты. ERP, CRM, документооборот, универсальный файловый архив, интерфейсы рабочих мест и BI-платформы остаются самостоятельными системами и решениями.
...
Физические оригиналы файловой поставки и `raw` относятся к одному поступлению на разных уровнях его представления. Файлы сохраняют исходное содержимое поставки, `raw` — полученные структурированные данные.
