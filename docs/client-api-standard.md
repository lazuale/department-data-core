...
Действующие контракты сохраняются. Несовместимое изменение оформляется новой операцией либо согласованной миграцией клиентов. Отдельная система версий API в первой реализации не обязательна.
